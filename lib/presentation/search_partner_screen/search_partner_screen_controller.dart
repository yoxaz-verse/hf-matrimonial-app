...
part 'search_partner_screen_controller.g.dart';

@riverpod
class SearchPartnerScreenController extends _$SearchPartnerScreenController {
  TextEditingController searchPartnerScreenController= TextEditingController();
